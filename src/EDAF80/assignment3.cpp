...
edaf80::Assignment3::run()
{
	...
	auto my_cube_map_id = bonobo::loadTextureCubeMap(config::resources_path("cubemaps/skybox/right.jpg"),
		config::resources_path("cubemaps/skybox/left.jpg"),
		config::resources_path("cubemaps/skybox/top.jpg"),
		config::resources_path("cubemaps/skybox/bottom.jpg"),
		config::resources_path("cubemaps/skybox/front.jpg"),
		config::resources_path("cubemaps/skybox/back.jpg"));
	...
	//
	auto skybox_shape = parametric_shapes::createSphere(40.0f, 200u, 200u);
